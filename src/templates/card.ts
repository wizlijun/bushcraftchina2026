...
const ICON_XIAOHONGSHU = `<svg width="56" height="18" viewBox="0 0 56 18"><rect width="56" height="18" rx="9" fill="currentColor"/><text x="28" y="13" text-anchor="middle" font-family="Montserrat,system-ui,-apple-system,sans-serif" font-size="10" font-weight="500" fill="white" letter-spacing="0.5">rednote</text></svg>`;
